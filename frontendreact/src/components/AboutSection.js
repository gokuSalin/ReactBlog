    ...
    return(
        ...
        <section className="tm-section">
            <div className="container-fluid">
                <div className="row tm-2-rows-sm-swap">
                    <div className="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 tm-2-rows-sm-down-2">
                        
                        <h3 className="tm-gold-text">Sidebar Links</h3>
                    ...
                    <div className="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9 tm-2-rows-sm-down-1">
                ...
                <div className="row tm-margin-t-mid">
                    <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 tm-sm-m-b">
                        <h3 className="tm-gold-text">Pellentesque fermentum mauris</h3>
                ...
                <div className="row tm-margin-t-mid">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3 col-lg-3 col-xl-3">
                        ...
                        <div className="tm-content-box tm-margin-b-30">
